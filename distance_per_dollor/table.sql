...
CREATE TABLE uber_request_logs (
    ...
    distance_to_travel DECIMAL(5, 2),
    monetary_cost DECIMAL(5, 2),
    driver_to_client_distance DECIMAL(5, 2)
);

-- Insert the data
INSERT INTO uber_request_logs (request_id, request_date, request_status, distance_to_travel, monetary_cost, driver_to_client_distance) VALUES
...
(8, '2020-04-23', 'success', 48.22, 11.20, 48.82),
(9, '2020-05-08', 'success', 56.63, 4.04, 16.08),
(10, '2020-05-23', 'fail', 19.03, 16.65, 11.22),
(11, '2020-06-07', 'fail', 81.00, 6.56, 26.60),
...
(16, '2020-08-21', 'success', 46.49, 1.84, 41.90),
(17, '2020-09-05', 'fail', 45.98, 12.20, 2.46),
(18, '2020-09-20', 'success', 3.14, 24.80, 36.60),
